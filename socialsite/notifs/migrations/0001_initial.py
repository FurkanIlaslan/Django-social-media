# Generated by Django 4.2.30 on 2026-04-26 18:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notification_type', models.CharField(choices=[('like', 'Beğeni'), ('comment', 'Yorum'), ('reply', 'Yanıt'), ('follow', 'Takip'), ('message', 'Mesaj')], max_length=20)),
            ...
            options={
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['receiver', 'is_read'], name='notifs_noti_receive_6bbc63_idx'), models.Index(fields=['-created_at'], name='notifs_noti_created_329294_idx')],
            },
        ),
    ]
